...
// src/app/features/connect_player.component.ts
var _ConnectPlayerComponent = class _ConnectPlayerComponent {
  constructor(http) {
    this.http = http;
    this.player = {
      username: ""
  ...
  login() {
    console.log(this.player);
    this.http.post(`/battleship/v1.0/players`, this.player, {
      headers: {
...
_ConnectPlayerComponent.\u0275fac = function ConnectPlayerComponent_Factory(t) {
  return new (t || _ConnectPlayerComponent)(\u0275\u0275directiveInject(HttpClient));
};
_ConnectPlayerComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConnectPlayerComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 1, consts: [[3, "submit"], ["type", "text", "id", "nickname", "name", "nickname", "placeholder", "nickname", 3, "ngModel", "ngModelChange"], ["type", "submit"]], template: function ConnectPlayerComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h1");
    \u0275\u0275text(1, "Battleship Free-For-All");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "h2");
    \u0275\u0275text(3, "Choose your nickname");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "form", 0);
    \u0275\u0275listener("submit", function ConnectPlayerComponent_Template_form_submit_4_listener() {
      return ctx.login();
    });
    \u0275\u0275elementStart(5, "div")(6, "input", 1);
    \u0275\u0275listener("ngModelChange", function ConnectPlayerComponent_Template_input_ngModelChange_6_listener($event) {
      return ctx.player.username = $event;
    });
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    \u0275\u0275advance(6);
    \u0275\u0275property("ngModel", ctx.player.username);
  }
}, dependencies: [CommonModule, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm, ReactiveFormsModule], encapsulation: 2 });
var ConnectPlayerComponent = _ConnectPlayerComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConnectPlayerComponent, { className: "ConnectPlayerComponent", filePath: "src\\app\\features\\connect_player.component.ts", lineNumber: 27 });
})();
export {
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HQ6GVVU3.js.map
